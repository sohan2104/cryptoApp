...
import com.firstapp.ryptoapp.databinding.FragmentDetailsBinding
...
//        binding.detailPriceTextView.text = "${String.format("$%.4f", data.quote[0].price)}"
//
//        if (data.quote!![0].percentChange24h > 0){
//           binding.detailChangeTextView.setTextColor(requireContext().resources.getColor(R.color.green))
//            binding.detailChangeImageView.setImageResource(R.drawable.ic_caret_up)
//           binding.detailChangeTextView.text = "+ ${String.format("%.02f",data.quote[0].percentChange24h)} % "
//        } else{
