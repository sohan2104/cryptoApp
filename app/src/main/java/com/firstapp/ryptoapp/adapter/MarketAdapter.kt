package com.firstapp.ryptoapp.adapter
...
import com.firstapp.ryptoapp.databinding.CurrencyItemLayoutBinding
import com.firstapp.ryptoapp.fragment.HomeFragmentDirections
import com.firstapp.ryptoapp.fragment.MarketFragmentDirections
...
//           "${String.format("$%.02f", item.quote[0].price)} "

//        if (item.quote!![0].percentChange24h > 0){
//            holder.binding.currencyChangeTextView.setTextColor(context.resources.getColor(R.color.green))
//            holder.binding.currencyChangeTextView.text = "+ ${String.format("%.02f",item.quote[0].percentChange24h)} % "
//        } else{
