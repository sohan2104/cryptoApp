...
import com.firstapp.ryptoapp.databinding.TopCurrencyLayoutBinding
...
//            holder.binding.topCurrencyChangeTextView.text = "+ ${String.format("%.02f",item.quote[0].percentChange24h)} % "
//        } else{
